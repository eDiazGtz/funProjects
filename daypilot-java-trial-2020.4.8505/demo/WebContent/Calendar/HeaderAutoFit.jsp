...
<head>
	<meta charset="utf-8" />
	<demo:title>Header Height Auto-Fit (Calendar)</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<div class="note"><b>Note:</b> Use headerHeightAutoFit = true to automatically extend the header height if needed.</div>
...
var dpc = new DayPilot.Calendar("dpc_autofit");
dpc.backendUrl = '../dpc';
