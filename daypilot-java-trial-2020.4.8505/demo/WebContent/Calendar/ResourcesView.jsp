...
<head>
	<meta charset="utf-8" />
	<demo:title>Resources View (Calendar)</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
dpc.allDayEventBorderColor = "#a0a0a0";

dpc.viewType = "Resources";
dpc.columns = [
	{ Name: "A", Value: "A", Start: "2010-07-01T00:00:00"},            
	{ Name: "B", Value: "B", Start: "2010-07-01T00:00:00"},            
	{ Name: "C", Value: "C", Start: "2010-07-01T00:00:00"}            
];
