...
<head>
	<meta charset="utf-8" />
	<demo:title>Active Areas (Calendar)</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<div class="note"><b>Note:</b> Hold a cursor on an event or a column header to see the active areas.</div>
...
var dpc = new DayPilot.Calendar("dpc_areas");
dpc.backendUrl = '../dpc';
...
dpc.bubble = new DayPilot.Bubble({ cssClassPrefix: "bubble_default", hideAfter: 0 });
