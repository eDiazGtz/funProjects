...
<head>
	<meta charset="utf-8" />
	<demo:title>Recurring Events (AJAX Scheduler)</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<div id="dps_recurring"></div>

<script type="text/javascript">
var dps = new DayPilot.Scheduler("dps_recurring");
...
function editEvent(e) {
    ...
    modal.height = 280;
    if (!e.id()) {
    	modal.showHtml("Recurring event editing not implemented in this demo.");
    }
    else {
