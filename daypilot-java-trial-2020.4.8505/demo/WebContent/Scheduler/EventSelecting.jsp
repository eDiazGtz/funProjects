...
<head>
	<meta charset="utf-8" />
	<demo:title>Event Selecting</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<div class="note"><b>Note:</b> Use Ctrl+click to select multiple events. <a href="javascript:dps.commandCallBack('selected');">Show selected events</a></div>
...
dps.eventClickHandling = "Select";
dps.allowMultiSelect = true;
dps.multiSelectRectangle = "Free";
