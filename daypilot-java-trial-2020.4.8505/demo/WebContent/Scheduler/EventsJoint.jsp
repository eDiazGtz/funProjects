...
<head>
	<meta charset="utf-8" />
	<demo:title>AJAX Scheduler</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<div class="note"><b>Note:</b> Joint events will be moved together during drag and drop.</div>

<div id="dps_joint"></div>

<script type="text/javascript">
var dps = new DayPilot.Scheduler("dps_joint");
...
dps.multiMoveVerticalMode = "Master";
