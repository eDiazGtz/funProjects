...
<head>
	<meta charset="utf-8" />
	<demo:title>Prevent Parent Usage (Scheduler)</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<demo:header />
    ...
    <div class="note">
    <b>Note:</b> Scheduling events in parent tree nodes is disabled (treePreventParentUsage = true). Parent node cells color is set to "white" using OnBeforeCellRender event handler.
    </div>        

<div id="toolbar">
	<a href="javascript:dps.commandCallBack('previous');">&#x25c4;</a>
	<a href="javascript:dps.commandCallBack('next');">&#x25ba;</a>
	<a href="javascript:dps.commandCallBack('this');">This Year</a>
</div>

<div id="dps_parents"></div>

<script type="text/javascript">
var dps = new DayPilot.Scheduler("dps_parents");
...
dps.treePreventParentUsage = true;
dps.init();
</script>
