...
<head>
	<meta charset="utf-8" />
	<demo:title>Percent Complete (Scheduler)</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<div class="note"><b>Note:</b> Use durationBarMode = "PercentComplete" and onBeforeEventRender/ea.setPercentComplete().</div>

<div id="dps_complete"></div>

<script type="text/javascript">
var dps = new DayPilot.Scheduler("dps_complete");
...
dps.durationBarMode = "PercentComplete";
