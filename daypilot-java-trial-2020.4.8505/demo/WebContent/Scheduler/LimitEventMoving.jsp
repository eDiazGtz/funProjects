...
<head>
	<meta charset="utf-8" />
	<demo:title>Limit Event Moving (Scheduler)</demo:title>
	<demo:scripts />
	<demo:css />
	<demo:head />
</head>
...
<demo:header />
    ...
    <div class="note">
    <b>Note:</b> Blue events can be only moved vertically. Red events can only be moved horizontally.
    </div>
...
<div id="dps_limit"></div>

<script type="text/javascript">
var dps = new DayPilot.Scheduler("dps_limit");
